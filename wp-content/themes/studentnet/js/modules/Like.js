...
class Like {
  ...
  async createLike(currentLikeBox) {
    try {
      const response = await axios.post(studentnetData.root_url + "/wp-json/studentnet/v1/manageLike", { "professorId": currentLikeBox.getAttribute("data-professor") })
  ...
  async deleteLike(currentLikeBox) {
    try {
      const response = await axios({
        url: studentnetData.root_url + "/wp-json/studentnet/v1/manageLike",
        method: 'delete',
